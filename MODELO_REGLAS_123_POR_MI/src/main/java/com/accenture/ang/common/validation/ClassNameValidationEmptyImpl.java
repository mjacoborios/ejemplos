 ...
 * 
 * Project Name: ANG_ARCHITECTURE_COMMON
 * Description : This jar contains the utility classes
 * Artifact ID : ANG_ARCHITECTURE_COMMON
 * 
...
public class ClassNameValidationEmptyImpl implements ClassNameValidation {
