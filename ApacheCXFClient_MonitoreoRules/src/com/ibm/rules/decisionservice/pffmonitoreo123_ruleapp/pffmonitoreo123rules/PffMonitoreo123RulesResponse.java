...
@XmlRootElement(name = "PffMonitoreo123rulesResponse")
public class PffMonitoreo123RulesResponse {

    @XmlElement(name = "DecisionID", namespace = "http://www.ibm.com/rules/decisionservice/PffMonitoreo123_RuleApp/PffMonitoreo123rules", required = true)
